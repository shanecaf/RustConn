...
- Dependencies: cc 1.5.1, hyper-util 0.1.21, wasm-bindgen 0.2.129, web-sys 0.3.106, zerocopy 0.8.59, smallvec 1.16.2 and related; both cargo-sources.json regenerated
...
- Improved: the "only reconnect a disconnected session" guard now lives in the one function every in-place reconnect passes through, so no path can reset a live terminal (issue #328); no user-visible change today
