...
pub static DOWNLOADABLE_COMPONENTS: &[DownloadableComponent] = &[
    ...
    DownloadableComponent {
        ...
        category: ComponentCategory::ZeroTrust,
        install_method: InstallMethod::Download,
        download_url: Some("https://cdn.teleport.dev/teleport-v18.7.5-linux-amd64-bin.tar.gz"),
        aarch64_url: Some("https://cdn.teleport.dev/teleport-v18.7.5-linux-arm64-bin.tar.gz"),
        checksum: ChecksumPolicy::SkipLatest,
        pip_package: None,
        size_hint: "~100 MB",
        binary_name: "tsh",
        install_subdir: "teleport",
        pinned_version: Some("18.7.5"),
        works_in_sandbox: true,
    },
    DownloadableComponent {
        id: "tailscale",
